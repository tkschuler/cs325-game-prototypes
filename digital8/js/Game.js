...
BasicGame.Game.prototype = {
    ...
    create: function () {
        ...
        this.game.time.events.add(Phaser.Timer.SECOND * this.spawn, this.spawnShield, this);
        this.game.time.events.add(Phaser.Timer.SECOND * this.spawn2, this.spawnHealth, this);
    ...
    spawnShield: function () {
        this.shieldpowerup = this.game.add.sprite(this.game.rnd.integerInRange(100, 700),this.game.rnd.integerInRange(100, 500), 'shieldpowerup');
        this.game.physics.arcade.enable(this.shieldpowerup);
        
        this.shieldpowerup.body.velocity.x = this.game.rnd.integerInRange(-150, 150);
        this.shieldpowerup.body.velocity.y = this.game.rnd.integerInRange(-150, 150);
        
        this.game.time.events.add(Phaser.Timer.SECOND * this.spawn, this.spawnShield, this);
    },
    
    spawnHealth: function () {
        this.healthpowerup = this.game.add.sprite(this.game.rnd.integerInRange(100, 700),this.game.rnd.integerInRange(100, 500), 'healthpowerup');
        this.game.physics.arcade.enable(this.healthpowerup);
    
        this.healthpowerup.body.velocity.x = this.game.rnd.integerInRange(-150, 150);
        this.healthpowerup.body.velocity.y = this.game.rnd.integerInRange(-150, 150);
