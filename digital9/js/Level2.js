...
create: function () {
    ...
    this.blacksquare = this.game.add.sprite(400, 200, 'blacksquare');
    ...
    this.greensquare = this.greensquares.create(400, 385, 'greensquare');
    this.greensquare.body.mass = -50;
    this.greensquare.overlap = false;
    ...
    this.redsquare.body.mass = -50;
    this.redsquare.overlap = false;
    this.redsquare = this.redsquares.create(400, 325, 'redsquare');
    this.redsquare.body.mass = -50;
    this.redsquare.overlap = false;
    
    
    
    this.sq = this.blacksquares.create(430, 330, 'solidblack');
    this.sq.body.immovable = true;
    this.sq = this.blacksquares.create(430, 270, 'solidblack');
    this.sq.body.immovable = true;
    this.sq = this.blacksquares.create(370, 330, 'solidblack');
    this.sq.body.immovable = true;
    this.sq = this.blacksquares.create(370, 270, 'solidblack');
    this.sq.body.immovable = true;
    this.sq = this.blacksquares.create(400, 410, 'solidblack');
    this.sq.body.immovable = true;
    this.sq = this.blacksquares.create(345, 300, 'solidblack');
    this.sq.body.immovable = true;
    this.sq = this.blacksquares.create(370, 355, 'solidblack');
    this.sq.body.immovable = true;
    this.sq = this.blacksquares.create(430, 355, 'solidblack');
    this.sq.body.immovable = true;
...
update: function () {
    ...
    if (this.redCount == 4  && this.greenCount == 2){
        ...
        this.greybg.events.onInputDown.add( function() { this.state.start('Level3'); }, this );
